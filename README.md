...
| **Multi-Photo Interaction Viewer Prototype** (Evolve web — camera icon popup with left/right arrows on Interactions tab) | [mtmcallen.github.io/priority-score-simulator/docs/designs/answer-option-multi-photo-interaction-viewer-prototype.html](https://mtmcallen.github.io/priority-score-simulator/docs/designs/answer-option-multi-photo-interaction-viewer-prototype.html) |
